...
{
  /// <summary>
  /// All entity classes without an 'int' primary key and without the PDSC standard fields should inherit from this base class
  /// </summary>
  public class TableEntityBaseStringPKNoStdFields : EntityBase
  { 
