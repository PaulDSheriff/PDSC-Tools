...
namespace PDSC.Common.ViewModelLayer
{
  public partial class PrivacyPolicyViewModel : ViewModelBase
  {
    ...
    /// </summary>
    public PrivacyPolicyViewModel() : base()
    {
      Init();
    }

    public PrivacyPolicyViewModel(IRepository<PrivacyPolicy, PrivacyPolicySearch> repository) : base()
    {
      Init();
    ...
    #region Properties
    public IRepository<PrivacyPolicy, PrivacyPolicySearch> Repository { get; set; }
    public List<PrivacyPolicy> DataCollection { get; set; }
    public PrivacyPolicy SelectedEntity { get; set; }
    public PrivacyPolicySearch SearchEntity { get; set; }
    #endregion
    ...
    public override void Init()
    {
      ...
      DataCollection = new List<PrivacyPolicy>();
      SelectedEntity = new PrivacyPolicy();
      SearchEntity = new PrivacyPolicySearch();

      SortExpression = "PrivacyText";
    ...
    public override void Search()
    {
      ...
      // Store Search Data
      base.StoreSearchAsJson<PrivacyPolicySearch>(SearchEntity);
    ...
    public void RestoreSearchFromJson()
    {
      if (!string.IsNullOrEmpty(SearchAsJson)) {
        SearchEntity = base.RestoreSearchFromJson<PrivacyPolicySearch>(SearchAsJson);
      }
    }
    #endregion
    ...
    public override bool Save()
    {
      ...
      if (Validate()) {
        if (SelectedEntity.PrivacyPolicyId.HasValue) {
          // Set Tracking Fields
