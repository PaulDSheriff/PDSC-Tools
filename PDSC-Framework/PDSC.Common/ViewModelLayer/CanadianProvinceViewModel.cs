...
{
  public partial class CanadianProvinceViewModel : ViewModelBaseStringPK
  {
    #region Constructors
    /// <summary>
    ///  NOTE: You need to have a parameterless constructor for Post-Backs in MVC    
    /// </summary>
    public CanadianProvinceViewModel() : base()
    {
      Init();
    }

    public CanadianProvinceViewModel(IRepositoryStringPK<CanadianProvince, CanadianProvinceSearch> repository) : base()
    {
      Init();
    ...
    #region Properties
    public IRepositoryStringPK<CanadianProvince, CanadianProvinceSearch> Repository { get; set; }
    public List<CanadianProvince> DataCollection { get; set; }
    public CanadianProvince SelectedEntity { get; set; }
    public CanadianProvinceSearch SearchEntity { get; set; }
    #endregion
    ...
    public override void Init()
    {
      ...
      DataCollection = new List<CanadianProvince>();
      SelectedEntity = new CanadianProvince();
      SearchEntity = new CanadianProvinceSearch();
    ...
    public override void Search()
    {
      ...
      // Store Search Data
      base.StoreSearchAsJson<CanadianProvinceSearch>(SearchEntity);
    ...
    public void RestoreSearchFromJson()
    {
      if (!string.IsNullOrEmpty(SearchAsJson)) {
        SearchEntity = base.RestoreSearchFromJson<CanadianProvinceSearch>(SearchAsJson);
      }
    }
    #endregion
