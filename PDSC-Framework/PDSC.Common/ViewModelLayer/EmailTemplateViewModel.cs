...
{
  public partial class EmailTemplateViewModel : ViewModelBase
  {
    #region Constructors
    /// <summary>
    ///  NOTE: You need to have a parameterless constructor for Post-Backs in MVC    
    /// </summary>
    public EmailTemplateViewModel() : base()
    {
      Init();
    }

    public EmailTemplateViewModel(IRepository<EmailTemplate, EmailTemplateSearch> repository) : base()
    {
      Init();
    ...
    #region Properties
    public IRepository<EmailTemplate, EmailTemplateSearch> Repository { get; set; }
    public List<EmailTemplate> DataCollection { get; set; }
    public EmailTemplate SelectedEntity { get; set; }
    public EmailTemplateSearch SearchEntity { get; set; }
    #endregion
    ...
    public override void Init()
    {
      ...
      DataCollection = new List<EmailTemplate>();
      SelectedEntity = new EmailTemplate();
      SearchEntity = new EmailTemplateSearch();

      SortExpression = "EmailTemplateName";
    ...
    public override void Search()
    {
      ...
      // Store Search Data
      base.StoreSearchAsJson<EmailTemplateSearch>(SearchEntity);
    ...
    public void RestoreSearchFromJson()
    {
      if (!string.IsNullOrEmpty(SearchAsJson)) {
        SearchEntity = base.RestoreSearchFromJson<EmailTemplateSearch>(SearchAsJson);
      }
    }
    #endregion
    ...
    public override bool Save()
    {
      ...
      if (Validate()) {
        if (SelectedEntity.EmailTemplateId.HasValue) {
          // Set Tracking Fields
