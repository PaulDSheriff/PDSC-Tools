...
namespace PDSCFramework.Controllers
{
  ...
  public partial class FAQController : AppControllerBase
   {
      #region Constructor
      /// <summary>
      /// Constructor for FAQController class
      /// </summary>
      public FAQController(AppSession session,
        AppSettings settings,
        IRepository<FAQ, FAQSearch> repo) : base(session, settings)
      {
        _repo = repo;
      }
      #endregion
      ...
      private readonly IRepository<FAQ, FAQSearch> _repo;
      #endregion

      #region FAQIndex Methods
      /// <summary>
      /// Executes when browser issues a Get request for /FAQ and 
      /// directs to the Index view
      /// </summary>
      /// <returns>An ActionResult that contains an instance of FAQViewModel</returns>
      public ActionResult FAQIndex()
      {
        // Create view model and pass in repository
        FAQViewModel vm = new(_repo);
      ...
      /// <summary>
      /// Handles the browser Post request for FAQ form
      /// </summary>
      /// <param name="vm">A FAQViewModel instance for the entry</param>
      /// <returns>An ActionResult that either navigates to the index or stays on this view and displays errors</returns>
      [HttpPost]
      public ActionResult FAQIndex(FAQViewModel vm)
      {
      ...
      [HttpGet]
      public IActionResult Search(FAQViewModel vm)
      {
        // Assign Repository to View Model
        vm.Repository = _repo;
        ...
        return View("FAQIndex", vm);
      }
      #endregion
   
      #region SortPage Method
      [HttpGet]
      public IActionResult SortPage(FAQViewModel vm)
      {
        // Assign Repository to View Model
        vm.Repository = _repo;
